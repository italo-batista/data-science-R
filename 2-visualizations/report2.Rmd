...
No gráfico, *as linhas representam uma ponderação das avaliações de episódios* de uma série específica. Com o gráfico, por exemplo, **a gente vê que Game of Thrones é significativamente melhor avaliada do que as outras temporadas**.
...
add_trace(size=~sqrt(UserVotes), color=~series_name, visible="legendonly", jitter=1) %>%
