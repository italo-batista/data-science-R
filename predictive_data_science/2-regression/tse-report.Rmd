...
### Quais variáveis conseguem explicar melhor o número de votos? Comparando entre os modelos. 

Se retornarmos ao sumário dos modelos, perceberemos que muitas variáveis têm um p-valor maior que 0.05. Para essas variáveis, suas chances de estarem relacionadas à variável votos por aleatoriedade é muito alta. Desse modo, poderíamos ter um modelo com mesma significância porém mais simples se removêssemos essas variáveis com o p-valor maior que 0.05. Se assim procedermos, para 2006 ficaremos com: 
...
Para 2010, fazendo a mesmo análise, obtemos o mesmo conjunto de variáveis.
