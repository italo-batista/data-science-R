...
highchart() %>%
  hc_add_series(data_ceap_by_year, "column", hcaes(x = year, y = totalExpenditure, group = tipoDespesa)) %>%
  hc_add_series(name = "Museu Nacional", investiment.mn.filter.year, "line", hcaes(x = year, y = investiment), color = COLOR_RED) %>%
